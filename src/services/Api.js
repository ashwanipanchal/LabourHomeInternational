...
const Api = {
    ...
    // custmerRegisterStep4: json => requestMultipart('custmerRegister_step4', json),
    ...
    rejectUser: json => request('reject_user_job', json),
    remainingPlan: json => request('remaining_plan', json),
    getAllSubscriptionPlan: json => request('get_all_subscription_plan', json),
    countrie: () => requestGet('countrie'),
    jobApply: json => request('job_apply', json),
    buySubscriptionPlan: json => request('buy_subscribe_plan', json),
    ...
    postJobClose: json => request('post_job_close', json),
    personalProfileEdit: json => request('personal_profile_edit', json),
    professionalProfileEdit: json => request('professional_profile_edit', json),
    documentProfileEdit: json => request('document_profile_edit', json),
    ...
    updateSkillStatus: json => request('skill_doc_user_status', json),
    skillCertificateUpload: json => request('skill_certificate_document_upload_user', json),
    jobStatusUser: json => request('job_status_user', json),
    paymentForUser: json => request('payment_job', json),
    searchKeyJob: json => request('search_lists', json),
    completeInterview: json => request('complete_interview', json),
    getNotification: json => request('get_notifications', json),
    acceptInterview: json => request('confirm_schedule_interview', json),
    uploadAppointmentLetter: json => requestMultipart('appointment_letter_upload', json),
    appointmentLetterList: json => request('appointment_letter_list', json),
    filter: json => request('filter', json),
...
const LocalStorage = {
    ...
    setFormData: formData => AsyncStorage.setItem('formData', FormData),
    getFormData: () => AsyncStorage.getItem('formData'),
